...
func main() {
	app := &cli.App{
		...
		Action: func(c *cli.Context) error {
			...
			log.Info("/ue/interface/:interface/wifi/metrics/:interval")
			log.Info("/ue/interface/:interface/network/status/:interval")
			log.Info("/ue/interface/:interface/throughput/monitor/:interval")
			log.Info("/ue/info")
			log.Info("---------------------------------------------")
