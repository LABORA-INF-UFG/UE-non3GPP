...
curl "$BASE_URL/imsi-$imsi/$plmnid" \
    ...
    -H 'Content-Type: application/json;charset=UTF-8' \seq
    -H 'Token: admin' \
    -H 'User-Agent: Mozilla/5.0 (X11; Linux x86_s64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/107.0.0.0 Safari/537.36' \
